...
class Random_fly_controller(object):
    ...
    def cmd_controller_output(self, pos_now, pos_des, yaw_now, yaw_des):
    ...
    # yaw_dotの計算
        ...
        self.yaw_dot = self.yawp*self.yaw_err
