    ...
    def main(self):
        ...
        while True:
            ...
            # turtlebot3における変換
                ...
                # self.RPY_t = tf.transformations.euler_from_quaternion((t.pose.orientation.x, t.pose.orientation.y, t.pose.orientation.z, t.pose.orientation.w))   
                # turtlebot3の座標をまとめる(z方向は固定の高さにすること)
                self.pos_des = list(self.Xp, self.Zp, 0.5)             
...
# $ export PYTHONPATH=$PYTHONPATH:~/crazyswarm/ros_ws/crazyswarms/scripts (PATHを通す)
