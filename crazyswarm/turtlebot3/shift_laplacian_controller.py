...
class Vel_controller(object):
    ...
    def __init__(self):
        ...
        self.consensus_equailateral_triangle3 = np.array([[0.5, -np.sqrt(3.0)/4, 0.75, 0.0],
                                                          [0.0, np.sqrt(3.0)/4, 0.75, 0.0],
                                                          [-0.5, -np.sqrt(3.0)/4, 0.75, 0.0],
                                                          [0.0, 0.0, 0.75, 0.0]])                                    
    ...
    def cmd_controller_output(self, cfs_state_now, yaw_des, L, cur_cf_idx, turtle_pos_X, turtle_pos_Y):
        ...
        self.fake_pos = cfs_state_now[:, :] - self.consensus_equailateral_triangle3
